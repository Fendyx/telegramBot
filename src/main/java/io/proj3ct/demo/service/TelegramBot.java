...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    static final String MONDAY = "1) Англійська мова\n" +
            ...
            "4) Іспанська мова(1група) / інформатика(2група)\n" +
            "5) Фізична культура\n" +
            "6) Фізика\n" +
            "7) Біологія і екологія";
    static final String TUESDAY = "1) Інформатика(1група) / Іспанська мова(2група)\n" +
            "2) Англійська мова\n" +
            "3) Алгебра\n" +
            "4) Українська мова\n" +
            "5) Географія\n" +
    ...
    static final String THURSDAY = "1) Фізика\n" +
            ...
            "5) Українська мова\n" +
            "6) Фізична культура\n" +
            "7) Іспанська мова(1група)";
    static final String FRIDAY = "1) Іспанська мова(2група)\n" +
            "2) Англійська мова\n" +
            "3) Алгебра\n" +
            "4) Захист України\n" +
    ...
    static final String TEACHERS = "Англійська мова: Супрун Тетяна Володимирівна / Бунякіна Наталія Анатоліївна\n\n" +
            "Алгебра та геометрія: Полєвікова Тетяна Павлівна\n\n" +
